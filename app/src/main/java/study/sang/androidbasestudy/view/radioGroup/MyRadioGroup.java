...
public class MyRadioGroup extends ViewGroup implements View.OnClickListener{
    ...
    public MyRadioGroup(Context context, AttributeSet attrs,
        ...
        childMarginHorizontal = arr.getDimensionPixelSize(
                R.styleable.MyRadioGroup_child_margin_horizontal, 15);
        childMarginVertical = arr.getDimensionPixelSize(
                R.styleable.MyRadioGroup_child_margin_vertical, 5);
        childResId = arr.getResourceId(
                R.styleable.MyRadioGroup_child_layout, 0);
        childCount = arr.getInt(R.styleable.MyRadioGroup_child_count, 0);
        singleChoice = arr.getBoolean(
                R.styleable.MyRadioGroup_single_choice, true);
        childValuesId = arr.getResourceId(
                R.styleable.MyRadioGroup_child_values, 0);
        gravity = arr.getInt(R.styleable.MyRadioGroup_gravity, LEFT);
        if (childResId == 0) {
